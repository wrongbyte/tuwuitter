...
export default function SetPasswordModal() {
  return (
    <ModalLayout>
      ...
      <p className="font-small-login adjust-login-title">Make sure it's 8 characters or more.</p>
      <form>
        {/* TODO: add button to hide or view password */}
        <input type="password" className="login-input-register" placeholder="Password" />
      </form>
